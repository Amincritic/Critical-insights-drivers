...
echo "    devices/draeger-medibus/build/install/draeger/bin/draeger"
echo "    devices/philips-intellivue/build/install/philips/bin/philips"
echo "    devices/philips-intellivue/build/install/philips/bin/philips-serial"
echo "    runtime/build/install/gateway-runtime/bin/gateway-runtime"
...
echo "  ../scripts/run-simulator.sh    Run extensible simulator runtime"
echo "  ../scripts/run-simulator-gui.sh Run legacy Swing simulator GUI"
