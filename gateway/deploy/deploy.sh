...
./gradlew :devices:philips-intellivue:installDist :devices:draeger-medibus:installDist :runtime:installDist --quiet
...
sudo cp "$INSTALL_DIR/openice-gateway-runtime.service" /etc/systemd/system/
sudo chmod 644 /etc/systemd/system/openice-gateway-runtime.service
sudo systemctl daemon-reload
echo "  Installed openice-gateway-runtime.service"
...
echo "     sudo nano /etc/systemd/system/openice-gateway-runtime.service"
echo ""
echo "  2. Start the service:"
echo "     sudo systemctl enable openice-gateway-runtime"
echo "     sudo systemctl start openice-gateway-runtime"
echo ""
echo "  3. Monitor:"
echo "     sudo journalctl -u openice-gateway-runtime -f"
echo "     tail -f $LOG_DIR/bed01.jsonl"
echo ""
echo "  4. Check health (once running):"
echo "     sudo systemctl status openice-gateway-runtime"
echo "     ls -la $LOG_DIR/"
