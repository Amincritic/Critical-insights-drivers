...
public final class HeadlessPhilipsGatewayApp {
    ...
    static final class Args {
        ...
        static void usageAndExit() {
            System.out.println("Usage: HeadlessPhilipsGatewayApp --host <monitor-ip> [--port 24105] [--device-id id] [--jsonl file] [--output-format canonical] [--dead-letter-jsonl file] [--http-url url] [--allow-insecure-http true|false] [--http-header 'Authorization: Bearer TOKEN'] [--stdout true|false]");
            System.exit(0);
        }
    }
}
